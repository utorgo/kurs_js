...
//////////////////HOME WORK//////////////////////
	var h2 = document.getElementsByClassName("heading");
	for(var i = 0; i < h2.length; i++) {
		h2[i].addEventListener("click",my_func,false);
	}
}
function my_func() {
	var res = this.nextElementSibling;
	if(res.getAttribute('class') == "my_class content") {
		res.setAttribute('class','content');
	}
	else {
		res.setAttribute('class','my_class content');
	}
